...
console.log("checking set email exits");
console.log("checking set email exits");
...
//       return;
//   }
//   const j=await controller.updateProfileListAdmin(email,req,res);
// console.log(j);
...
//   if (req.accepts('json')) {
//     res.status(400).json({ message: 'Failed to update profile or image' });
//   } else {
//     res.status(400).send('Failed to update profile or image'); // or render a specific error page
//   }
